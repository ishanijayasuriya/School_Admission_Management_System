...
// Fetch all Grade 1 applications
$stmt = $pdo->query("SELECT * FROM grade_1_applications ORDER BY submitted_at DESC");
...
<div class="admin-container">
  ...
  <nav class="sidebar">
    ...
    <ul>
      ...
      <li class="active"><a href="application_view.php"><i class="fas fa-tachometer-alt"></i> Application</a></li>
  ...
  <main class="main-content">
    <header class="top-bar"><h1>Document Verification</h1></header>
